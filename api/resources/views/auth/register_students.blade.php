    ...
    <div class="formCol">
        ...
        <div class="tab-content">
            ...
            <div class="register-form">
                <form class="form-prevent-multiple-submits recapcha-form" method="POST" action="{{ route('register_students') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <span class="invalid-feedback recaptch-error-message" style="display: none; color: red; text-align: left;">
...
<script>
    $(document).ready(function() {
        ...
        $("#social_network_1").on("change", function(e) {
            $('#social_url_1').val($("#social_network_1 option:selected").html() + ' ID');
        });
        $("#social_network_2").on("change", function(e) {
            $('#social_url_2').val($("#social_network_2 option:selected").html() + ' ID');
        });
    })
</script>
@endsection