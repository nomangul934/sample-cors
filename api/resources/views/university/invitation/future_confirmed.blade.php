...
@section('content')
    ...
    <div class="sl-pagebody">
        ...
        <form method = "get" action = "{{ route('university.future_university') }}" id = "frm_search">
                                ...
                                <div class="row content-txt">
                                    ...
                                    <div class="col-lg-10 col-sm-12 ">
                                        ...
                                        <div class="row content-txt">
                                            <div class="col-sm-2">
                                                <p class="university-content">
                                                    Grade 11: {{ $university->number_grade11 }}
                                                </p>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="university-content">
                                                    Fee: {{ $university->fees_11 }}
                                                </p>
                                            </div>

                                            <div class="col-sm-2">
                                                <p class="university-content">
                                                    Grade 12: {{ $university->number_grade12 }}
                                                </p>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="university-content">
                                                    Fee: {{ $university->fees_12 }}
                                                </p>
                                            </div>
                                            <div class="col-sm-2">
                                                <p class="university-content">
                                                    Total Student: {{ $university->number_grade11 + $university->number_grade12 }}
                                                </p>
                                            </div>
                                        </div>
                                        <div class="row ">
