...
<nav class="breadcrumb sl-breadcrumb">
    <span class="breadcrumb-item active">Workshop List</span>
</nav>
            ...
            <table id="datatable1" class="table display responsive nowrap">
                <thead>
                    <tr>
                        ...
                        <th class="wd-15p">Workshop Name</th>
                        <th class="wd-15p">Date</th>
                        <th class="wd-15p">Time</th>
                        <th class="wd-15p">Target Grade</th>
                        <th class="wd-15p">Max Students</th>
                        <th class="wd-15p">Description</th>
                        <th class="wd-15p">Confirm & Register</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Best course</td>
                        <td style="text-align: center;">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#modaldemo1">
                                Register
                            </button>
                        </td>
                    </tr>
